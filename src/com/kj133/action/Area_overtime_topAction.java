...
import com.kj133.entity.bo.Area_overtime_topBO;
 ...
 */
public class Area_overtime_topAction extends DispatchAction {
	...
	public ActionForward init(
        ...
        Area_overtime_topBO bo=new Area_overtime_topBO();
        WordlibBO lib=new WordlibBO();
	    try{
	    	Search_area_overtime_top  area_overtime_top=(Search_area_overtime_top)dy.getMap().get("area_overtime_top");
	        	 List list=bo.init(area_overtime_top);
	        	 ...
	        	 if( list.size()== 0){
	        		 ...
	        		 request.getSession().setAttribute("area_overtime_top", area_overtime_top);//结果集
	        		 request.getSession().setAttribute("area_overtime_topPrint", list);//结果集
	        	 }
				 List type=lib.workType();

				 request.setAttribute("workType_list",type);

	        	 dy.set("area_overtime_top",area_overtime_top);
	        }catch(Exception e){
	        ...
	        DynaActionForm dy=(DynaActionForm)form;
			  try{
				  Search_area_overtime_top area_overtime_top=(Search_area_overtime_top)dy.getMap().get("area_overtime_top");
			       ...
			       area_overtime_top.setStime(stime+" 00:00:00");
			       area_overtime_top.setEtime(etime+" 00:00:00");

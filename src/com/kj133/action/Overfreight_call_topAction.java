...
import com.kj133.entity.bo.Overfreight_call_topBO;
 ...
 */
public class Overfreight_call_topAction extends DispatchAction {
	...
	public ActionForward init(
        ...
        Overfreight_call_topBO bo=new Overfreight_call_topBO();
        WordlibBO lib=new WordlibBO();
	    try{
	    	Search_overfreight_call_top  overfreight_call_top=(Search_overfreight_call_top)dy.getMap().get("overfreight_call_top");
	    	Ouser user = (Ouser) request.getSession().getAttribute("user");
			String userid = user.getUserid();
	        	 List list=bo.init(overfreight_call_top,userid);
	        	 ...
	        	 if( list.size()== 0){
	        		 ...
	        		 request.getSession().setAttribute("overfreight_call_top", overfreight_call_top);//结果集
	        		 request.getSession().setAttribute("overfreight_call_topPrint", list);//结果集
	        	 }
	        	 List areatype = lib.areatype();
			      request.setAttribute("areatype_list",areatype);
			      List areaname = lib.areaname();
			      request.setAttribute("areaname_list",areaname);

	        	 dy.set("overfreight_call_top",overfreight_call_top);
	        }catch(Exception e){
		    ...
		    WordlibBO lib=new WordlibBO();
			  try{
				  Search_overfreight_call_top overfreight_call_top=(Search_overfreight_call_top)dy.getMap().get("overfreight_call_top");
			       ...
			       overfreight_call_top.setStime(stime+" 00:00:00");
			       overfreight_call_top.setEtime(etime+" 00:00:00");
			      List areatype = lib.areatype();
			      request.setAttribute("areatype_list",areatype);

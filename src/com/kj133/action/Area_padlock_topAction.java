...
import com.kj133.entity.bo.Area_padlock_topBO;
 ...
 */
public class Area_padlock_topAction extends DispatchAction {
	...
	public ActionForward init(
        ...
        Area_padlock_topBO bo=new Area_padlock_topBO();
	    try{
	    	Search_area_padlock_top  area_padlock_top=(Search_area_padlock_top)dy.getMap().get("area_padlock_top");
	        	 List list=bo.init(area_padlock_top);
	        	 ...
	        	 if( list.size()== 0){
	        		 ...
	        		 request.getSession().setAttribute("area_padlock_top", area_padlock_top);//结果集
	        		 request.getSession().setAttribute("area_padlock_topPrint", list);//结果集
	        	 }

	        	 dy.set("area_padlock_top",area_padlock_top);
	        }catch(Exception e){
	        ...
	        DynaActionForm dy=(DynaActionForm)form;
			  try{
				  Search_area_padlock_top area_padlock_top=(Search_area_padlock_top)dy.getMap().get("area_padlock_top");
			       ...
			       area_padlock_top.setStime(stime+" 00:00:00");
			       area_padlock_top.setEtime(etime+" 00:00:00");
			       request.getSession().setAttribute("listCount1", "0");
				   request.setAttribute("listCount", "0");
				   
				   dy.set("area_padlock_top",area_padlock_top);
				}catch(Exception e){
					log.error("==区域禁入报警初始化==",e);
				}
			    return mapping.findForward("show");
			 }
	 /**

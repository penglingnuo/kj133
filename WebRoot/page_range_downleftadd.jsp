...
<jsp:include flush="true" page="/checkUser.jsp"></jsp:include>
    ...
    <script language="javascript">
    			...
    			function check()
			{
			  ...
			  var parentarea=document.all['ser_pagerangetopleft.parentarea'].value;
			  ...
			  if( name == ""){
			      ...
			      alert('所属区域不能为空');
			      document.all['ser_pagerangetopleft.parentarea'].focus();
			      return false;
			  }if( maxsum == ""){
			      alert('定员数不能为空');
  ...
  <body bgColor="white" background="Image/right.gif">
        ...
        <!-- message -->
     <html:form action="/page_range_downleft?method=add" target="topright" onsubmit="return check()" focus="ser_pagerangetopleft.areaname">
     <td ><font size="2" color="red">二级区域增加设置:</font></td>
     <table >
     <tr>
           <td>&nbsp;&nbsp;区域名称：</td>
           <td>
     ...
     <tr>
           <td>&nbsp;&nbsp;区域类型：</td>
           <td>
           <html:select property="ser_pagerangetopleft.areatype"  style="width:100px">

...
<%@ page import="com.kj133.entity.Search_Locator_Batteries" %>
<%@ page import="java.util.*" %>
<%@ page import="java.io.*" %>
    <%
      //报表编译之后生成的.jasper 文件的存放位置
      response.reset();
      File reportFile = new File(application.getRealPath("reports/locator_batteries.jasper"));
      //传递报表中用到的参数值
      Search_Locator_Batteries jf = (Search_Locator_Batteries)request.getSession().getAttribute("locabatteries");
      
      Map parameters = new HashMap();     
      parameters.put("ktime",jf.getStime());
      parameters.put("jtime",jf.getEtime());
      
      List dyList = (ArrayList)request.getSession().getAttribute("Locator_batteries_ListPrint");

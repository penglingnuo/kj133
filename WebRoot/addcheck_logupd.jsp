...
<html:html lang="true">
    	...
    	source: function(request, response) {
                $.ajax({
                    ...
                    success: function(data) {
                       ...
                       names.push(this.stafferid+"--"+this.name);
					   });
  ...
  <body bgColor="white" background="Image/right.gif" >
     <logic:messagesPresent message="true">
      ...
      <html:form action="/addcheck_log?method=getlistworkattupd" onsubmit="return check()">
          <table width="100%">
               <tr>
                 ...
                 <th align="left"> 员工：
                 <html:text property="ser_addchecklog.stafferid" styleId="name" style="width: 125px;"></html:text>
                 </th> 
         ...
         <table width="100%"  cellspacing="1" cellpadding="1"  bgcolor="#6CA6CD" border="0" >
             <tr>
	           <td width="3%" align="left"  bgcolor="#B0C4DE">工号</td>
	           <td width="3%" align="left"  bgcolor="#B0C4DE">卡号</td>
	           <td width="5%"  align="left"  bgcolor="#B0C4DE">姓名</td>
	           <td width="9%" align="left"  bgcolor="#B0C4DE">部门</td>
	           <td width="9%" align="left"  bgcolor="#B0C4DE">工种</td>
	           <td width="9%"  align="left"	 bgcolor="#B0C4DE">职务</td>
	           <td width="13%"  align="left"  bgcolor="#B0C4DE">开始时间</td> 
	           <td width="13%"  align="left"  bgcolor="#B0C4DE">结束时间</td> 
	           ...
	           <td width="10%" align="left"  bgcolor="#B0C4DE">修改时间</td>
	           <td width="8%" align="left"  bgcolor="#B0C4DE">修改原因</td>
           </tr>
		    
          <logic:present name="list">
             <logic:iterate name="list" id="list">
                <tr>
                  <td align="left" bgcolor="#E6E6FA"><bean:write name="list" property="stafferid" /></td>
                  <td align="left" bgcolor="#E6E6FA"><bean:write name="list" property="cardid" /></td>
                  <td align="center" bgcolor="#E6E6FA"><a  href="addcheck_log.do?method=getlistworkattupdnew&stafferid=${list.stafferid}&downtime=${list.downtime}&uptime=${list.uptime}">
                  <bean:write name="list" property="name" /></a></td>
               ...
               <logic:present name="pagination" >
                  <tr>
					   <td colspan="13" align="center" bgcolor="#E6E6FA">
					        <page:pagination path="addcheck_log.do?method=getlistworkattupd" parameter="page" formName="Search_addchecklog_Form" />
					  </td>
                   </tr> 
                </logic:present> 
         </table>   

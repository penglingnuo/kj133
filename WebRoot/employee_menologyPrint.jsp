...
<%@ page import="com.kj133.entity.Search_Employeet_menology" %>
<%@ page import="java.util.*" %>
<%@ page import="java.io.*" %>
    <%
      //报表编译之后生成的.jasper 文件的存放位置
      response.reset();
      File reportFile = new File(application.getRealPath("reports/employee_menology.jasper"));
      //传递报表中用到的参数值
      Search_Employeet_menology jf = (Search_Employeet_menology)request.getSession().getAttribute("employee_menology");
      
      Map parameters = new HashMap();     
      parameters.put("sstime",jf.getStime());
    
      List dyList = (ArrayList)request.getSession().getAttribute("employee_menologyPrint");

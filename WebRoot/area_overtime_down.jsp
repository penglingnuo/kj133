...
<body bgColor="white" background="Image/right.gif">
	...
	<html:form action="area_overtime_down?method=init" onsubmit="return check()">
     <td ><font size="2" color="red">区域超时明细:</font>
     ...
     <td>
	    ...
	    <logic:notEqual name="listCount1" value="0">  
	     ...
	     <input type="button"  value="打印预览"  onclick="javascript:window.open('area_overtime_downPrint.jsp')">
	    </logic:notEqual>
     </td>
		...
		<table cellspacing="1" cellpadding="1" bgcolor="#6CA6CD" border="0"
			...
			<logic:present name="relist" scope="request">
				...
				<tr onmouseover="this.style.background='#CCCCCC'; " onmouseout ="this.style.background=''; this.style.borderColor=''">
						...
						<td align="left" bgcolor="#E6E6FA">
							<bean:write name="relist" property="stayinterval" />
						</td>
						<td align="left" bgcolor="#E6E6FA">
							<bean:write name="relist" property="limittime" />
						</td>
						<td align="left" bgcolor="#E6E6FA">
							<bean:write name="relist" property="downtime" />
						</td>
						<td align="left" bgcolor="#E6E6FA">
							<bean:write name="relist" property="settletime" />
						</td>
						<td align="left" bgcolor="#E6E6FA">

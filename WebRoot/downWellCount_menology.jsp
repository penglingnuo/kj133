...
<head>
	...
	<title>downWellCount_menology.jsp</title>
...
<body bgColor="white" background="Image/right.gif">
	...
	<html:form action="/downWellCount_menology?method=init">
		<table width="850">
			<tr>
				<th>
					选择年月:
				</th>
				<th><html:text property="downWellCount_menology.stime" size="6" onfocus="WdatePicker({skin:'whyGreen',isShowClear:false,dateFmt:'yyyy-MM',el:$dp.$('downWellCount_menology.stime')})"/></th>
				<%--
				<th>
					<html:text property="downWellCount_menology.stime" size="6"
						onfocus="this.blur()" />
					<A onclick="return showCalendar('downWellCount_menology.stime','y-mm');"
				...
				--%><th>
                 ...
                 <html:text property="downWellCount_menology.gro" style="width:100px;position:absolute;left:0px;"></html:text>
				</div>
                 ...
                 <html:text property="downWellCount_menology.type" style="width:82px;position:absolute;left:0px;"></html:text>
				</div>
                 </th>
                 
				 <%--<th >班 组：</th>
                 <th >
                   <html:select property="downWellCount_menology.gro" style="width:120px"> 
                 ...
                 <th>员 工:</th>
                 <th>
					<html:text property="downWellCount_menology.stafferid" size="15"
				...
				<th>
					...
					<logic:notEqual name="listCount" value="0">
						...
						<input type="button"  value="打印预览"  onclick="javascript:window.open('downWellCount_menologyPrint.jsp')">
					</logic:notEqual>
				</th>
		...
		<div id = "printdiv">
				...
				<logic:present name="relist">
					<logic:iterate name="relist" id="list">
						<tr onmouseover="this.style.background='#CCCCCC'; "
							...
							<td align="left" bgcolor="#ffffff">
								<bean:write name="list" property="worktime" />
							</td>
							<td align="left" bgcolor="#ffffff">
								<bean:write name="list" property="downsum" />
							</td>
							<td align="left" bgcolor="#ffffff">
			...
			<logic:present name="pagination">
				<tr>
					<td colspan="42" align="left" bgcolor="#E6E6FA">
					<page:pagination path="downWellCount_menology?method=init" parameter="page" formName="Search_downWellCount_menology_Form" />
					</td>
				</tr>
			</logic:present>
			--%></table></div>

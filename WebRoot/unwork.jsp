...
<jsp:include flush="true" page="/checkUser.jsp"></jsp:include>
  ...
  <body bgColor="white" background="Image/right.gif">
    <logic:messagesPresent message="true">
     ...
     <html:form action="unwork.do?method=getList" onsubmit="return check()" style="border-collapse:collapse;TABLE-LAYOUT:   fixed;   FONT-SIZE:   13px;">
      <table width="580">
            <tr>
                <th>考勤开始日期：</th>
           ...
           <tr>
              ...
              <th align="left"> 
	              ...
	              <logic:notEqual name="listCount" value="0">
	                  ...
	                  <input type="button"  value="打印预览"  onclick="javascript:window.open('unworkPrint.jsp')">
	              </logic:notEqual>
 ...
 <div id = "printdiv">
         <table cellspacing="1" cellpadding="1"  bgcolor="#6CA6CD" border="0" width="720" >
             <tr>
                 ...
                 <td width="80"  align="left"  bgcolor="#B0C4DE" >职务</td>
                 
            </tr>
            <logic:present name="unwork_List">
              <logic:iterate name="unwork_List" id="cou">
                  <tr  onmouseover="this.style.background='#CCCCCC'; " onmouseout ="this.style.background=''; this.style.borderColor=''" >
                      ...
                      <td align="left" bgcolor="#E6E6FA"><bean:write name="cou" property="cid" /></td>
                      ...
                      <td align="left" bgcolor="#E6E6FA"><bean:write name="cou" property="oation" /></td> 
                ...
                <logic:present name="pagination" >
                   <TR>
					  <TD colspan="7" align="center" bgcolor="#E6E6FA">
					          <page:pagination path="unwork.do?method=getList" name="pagination" parameter="page"  formName="Seach_DownWellCount_Form"/>
					  </TD>  
                    </TR> 
            </logic:present> 
         </table>    </div>

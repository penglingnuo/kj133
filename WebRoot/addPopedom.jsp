...
<html:html lang="true">
  ...
  <html:form action="popedom.do?method=addCheck" onsubmit="return check()">
  
    <table border="0" width="945" height="694">
       <tr>
          <td valign="top"><br></td><td align="center">
              <font size="4">增 加 权 限 (<font color="red"><%= request.getAttribute("uid").toString()  %></font>)</font>
              <input type="hidden" name="uid" value=<%= request.getAttribute("uid").toString()  %>>
          </td>
       </tr>
       <tr>
          <td valign="top"><br></td><td><font color="red">用户管理</font>&nbsp;&nbsp;<input type="checkbox" name="checkUser" value="checkbox" onClick="chkUserManager()" >(全选)</td>
       </tr>
       <tr>
       ...
       <tr><td valign="top"><br></td><td><hr></td></tr>
       <tr>
          <td valign="top"><br></td><td><font color="red">实时信息</font>&nbsp;&nbsp;<input type="checkbox" name="checkSys" value="checkbox" onClick="chkSystem()" >(全选)</td>
       </tr>
       <tr>
          <td valign="top"><br></td><td>&nbsp;&nbsp;&nbsp;
       ...
       <tr> 
          ...
          <td valign="top"><br></td><td><font color="red">数据查询</font>&nbsp;&nbsp;<input type="checkbox" name="checkInfo" value="checkbox" onClick="chkInformation()" >(全选)</td>
       </tr> 
       <tr>
          <td valign="top"><br></td><td>&nbsp;&nbsp;&nbsp;
        ...
        <tr><td valign="top"><br></td><td><hr></td></tr>
       <tr> 
          <td valign="top"><br></td><td><font color="red">人员定位</font>&nbsp;&nbsp;<input type="checkbox" name="checkOrie" value="checkbox" onClick="chkOrientation()" >(全选)</td>
       </tr> 
       <tr>
          <td valign="top"><br></td><td>&nbsp;&nbsp;&nbsp; 
        ...
        <tr><td valign="top"><br></td><td><hr></td></tr>
        <tr> 
          <td valign="top"><br></td><td><font color="red">报警信息</font>&nbsp;&nbsp;<input type="checkbox" name="checkCall" value="checkbox" onClick="chkCall_police()" >(全选)</td>
       </tr> 
       <tr>
          <td valign="top"><br></td><td>&nbsp;&nbsp;&nbsp; 
        ...
        <tr><td valign="top"><br></td><td><hr></td></tr>
        <tr> 
          <td valign="top"><br></td><td><font color="red">考勤管理</font>&nbsp;&nbsp;<input type="checkbox" name="checkOn" value="checkbox" onClick="chkCheck_on()" >(全选)</td>
       </tr> 
       <tr>
          <td valign="top"><br></td><td>&nbsp;&nbsp;&nbsp; 

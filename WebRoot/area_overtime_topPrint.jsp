...
<%@ page import="java.io.*" %>
    <%
      ...
      response.reset();
      File reportFile = new File(application.getRealPath("reports/area_overtime_top.jasper"));
      //传递报表中用到的参数值
      ...
      List dyList = (ArrayList)request.getSession().getAttribute("area_overtime_topPrint");

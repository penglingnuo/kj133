...
<jsp:include flush="true" page="/checkUser.jsp"></jsp:include>
  ...
  <body bgColor="white" background="Image/right.gif">
    <html:form action="showOcx?method=ocxAdd" focus="search_ocx.dbip" onsubmit="return check()" >     
	   <fieldset style="margin:0% 27% 0% 27%;border:1px solid #red;">
	     <legend style="padding:0.5px 0.5px;">数据库配置</legend>
	          <table border="0" align="center">
	            ...
	            <tr>
	               <td>数据库密码：</td>
	               <td>&nbsp;&nbsp;<html:password  property="search_ocx.dbpassword" size="21"/><font color="red">&nbsp;&nbsp;*</font></td>
	            </tr>
	         </table>       
	   </fieldset>
       ...
       <fieldset style="margin:0% 27% 0% 27%;border:1px solid #red;">
	     <legend style="padding:0.5px 0.5px;">连接设置</legend>
	          <table border="0" align="center">
	            ...
	            <tr>
	               <td>采集服务器端口：</td>
	               <td><html:text  property="search_ocx.cpost" styleId="cpost" onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="5"/><font color="red">&nbsp;&nbsp;*</font></td>
	            </tr>
	            <tr>
	               <td>地图号：</td>
	     ...
	     <legend style="padding:0.5px 0.5px;">时间设置</legend>
	         <table border="0" align="center">
	            <tr>
	                <td>定位保留中断：</td>
	                <td  align="left">&nbsp;
	                    <html:text property="search_ocx.lostlocator" styleId="loca"  disabled="false" size="8"/>
	                    <html:hidden property="search_ocx.hiddenlocator" styleId="hidd"/>
	                    <input type="checkbox"  id="chec" onClick="document.getElementById('loca').disabled=true;document.getElementById('loca').value='-1';document.getElementById('hidd').value='-1';if (!this.checked)  {document.getElementById('loca').value='0';document.getElementById('loca').disabled=false }" >始终保留
	                    <font color="red">&nbsp;&nbsp;*</font>
	               </td>
	             </tr>
	         </table>
    ...
    <script type="text/javascript">
          ...
          document.getElementById('loca').value="0";
          document.getElementById('cpost').value="34567";
          document.all('search_ocx.locatetype')[1].checked=true;
    </script>
  </body>
</html:html>

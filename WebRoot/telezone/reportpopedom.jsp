		...
		<script type="text/javascript">
			...
			$(function(){
				$("#userid div").hover(function(){
					...
					$.ajax({
						type: "POST",
						url: "reportpopedom.do?method=getOuserReportPopedom&tempID=" + Math.random() * 10000,
						data: "userid=" + userid,
						dataType: "text",
				...
				$("#modifyUserReportPopedom").bind("click", function(){
					...
					$.ajax({
						type: "POST",
						url: "reportpopedom.do?method=modifyOuserReportPopedom&tempID=" + Math.random() * 10000,

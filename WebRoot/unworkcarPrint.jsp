...
<%@ page import="com.kj133.entity.Search_unworkcar" %>
<%@ page import="java.util.*" %>
<%@ page import="java.io.*" %>
    <%
      //报表编译之后生成的.jasper 文件的存放位置
      response.reset();
      File reportFile = new File(application.getRealPath("reports/unworkcar.jasper"));
      //传递报表中用到的参数值
      Search_unworkcar jf = (Search_unworkcar)request.getSession().getAttribute("unworkcar");
      
      Map parameters = new HashMap();     
      parameters.put("sstime",jf.getStime());
      parameters.put("eetime",jf.getEtime());
      
      List dyList = (ArrayList)request.getSession().getAttribute("unworkcarPrint");

...
<%@ page import="java.io.*" %>
    ...
    <%
      ...
      response.reset();
      File reportFile = new File(application.getRealPath("reports/onLoad_Left.jasper"));
      //传递报表中用到的参数值
      Search_OnLoad jf = (Search_OnLoad)request.getSession().getAttribute("onload");
      
      Map parameters = new HashMap();     
      parameters.put("ktime",jf.getStime());
      parameters.put("jtime",jf.getEtime());
      
      List dyList = (ArrayList)request.getSession().getAttribute("On_load_leftPrint");

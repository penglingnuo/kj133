...
<%@ page import="java.io.*" %>
    <%
      ...
      response.reset();
      File reportFile = new File(application.getRealPath("reports/localizerQuery.jasper"));
      //传递报表中用到的参数值
...
//      parameters.put("eetime",jf.getEtime());  
      ...
      List dyList = (ArrayList)request.getSession().getAttribute("localizerQueryPrint");

...
<head>
	...
	<title>worktype_areadis_down.jsp</title>
...
<body bgColor="white" background="Image/right.gif">
	...
	<html:form action="worktype_areadis_down?method=init" onsubmit="return check()">
  
		<%-- 
          <div   style="overflow:auto;width:825;height:500;"> 
          --%>
          
          <td ><font size="2" color="red">工种区域分布表---人员明细:</font></td>
          <td>
	                 ...
	                 <logic:notEqual name="listCount1" value="0">
	                     ...
	                     <input type="button"  value="打印预览"  onclick="javascript:window.open('worktype_areadis_downPrint.jsp')">
	               </logic:notEqual>
                 </td>
                 <div id = "printdiv">

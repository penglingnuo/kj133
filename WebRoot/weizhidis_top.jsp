...
<jsp:include flush="true" page="/checkUser.jsp"></jsp:include>
  ...
  <body bgColor="white" background="Image/right.gif" >
     ...
     <td ><font size="2" color="red">详细信息</font></td>
         <TABLE width="250">
            <TR>
              <TD>位置：</TD>
              <TD>
          ...
          <TABLE width="650" cellspacing="1" cellpadding="1"  bgcolor="#6CA6CD" border="0">
             <TR>
                <TD width="100"  align="left" bgcolor="#B0C4DE">卡号<input type="checkbox" name="checkall" value="checkbox" onClick="CheckAll(Search_WeizhidisLeft_Form);">(全选)</TD>
                <TD width="60"  align="center" bgcolor="#B0C4DE">姓名</TD>        
                <TD width="50"  align="center" bgcolor="#B0C4DE">班组</TD>        
                <TD width="50"  align="center" bgcolor="#B0C4DE">区域</TD>        
                
                <TD width="100"  align="left" bgcolor="#B0C4DE">入井时间</TD>        
                <TD width="80"  align="center" bgcolor="#B0C4DE">时长</TD>        
                <TD width="80"  align="left" bgcolor="#B0C4DE">状态信息</TD>        
                <TD width="80"  align="center" bgcolor="#B0C4DE">时间</TD>        
                <TD width="50"  align="center" bgcolor="#B0C4DE">信号</TD>        
             </TR>

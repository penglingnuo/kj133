...
<html:html lang="true">
  ...
  <body bgColor="white" background="Image/right.gif" >
     <logic:messagesPresent message="true">
      ...
      <html:form action="/addcheck_log?method=getlistworkatt" onsubmit="return check()">
          <table width="100%">
               <tr>
         ...
         <table width="100%"  cellspacing="1" cellpadding="1"  bgcolor="#6CA6CD" border="0" >
             <tr>
	          ...
	          <!--   <td width="5%"  align="left"  bgcolor="#B0C4DE">修改人</td> 
	           <td width="13%" align="left"  bgcolor="#B0C4DE">修改时间</td>
               ...
               <logic:present name="pagination" >
                  <tr>
					   <td colspan="13" align="center" bgcolor="#E6E6FA">
					        <page:pagination path="addcheck_log.do?method=getlistworkatt" parameter="page" formName="Search_addchecklog_Form" />
					  </td>
                   </tr> 
                </logic:present> 
         </table>   

...
<%@ page import="com.kj133.entity.Search_emphases_report" %>
<%@ page import="java.util.*" %>
<%@ page import="java.io.*" %>
    <%
      //报表编译之后生成的.jasper 文件的存放位置
      response.reset();
      File reportFile = new File(application.getRealPath("reports/emphases_report.jasper"));
      //传递报表中用到的参数值
      Search_emphases_report jf = (Search_emphases_report)request.getSession().getAttribute("emphases_report");
      ...
      List dyList = (ArrayList)request.getSession().getAttribute("emphases_reportPrint");

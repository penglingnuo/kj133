...
<%@ page import="com.kj133.entity.Search_HistoryNote" %>
<%@ page import="java.util.*" %>
<%@ page import="java.io.*" %>
    <%
      //报表编译之后生成的.jasper 文件的存放位置
      response.reset();
      File reportFile = new File(application.getRealPath("reports/historyNote.jasper"));
      //传递报表中用到的参数值
      Search_HistoryNote jf = (Search_HistoryNote)request.getSession().getAttribute("HistoryNote_List");
      
      Map parameters = new HashMap();     
      parameters.put("ktime",jf.getStime());
      parameters.put("jtime",jf.getEtime());
      
      List dyList = (ArrayList)request.getSession().getAttribute("HistoryNote_ListPrint");

...
<html:html lang="true">
  <head>
    ...
    function OpenExcel(){
			  window.parent.location.href="workattleader.do?method=doOpenExcel";
			     return true;
		    }
    ...
    <script type="text/javascript">
    	function refresh(){
		window.location.href="workattleader.do?method=getList"; 
	}
	function gjdetail(cardid,downtime){
			$.ajax({
			  type: "POST",
			  data:{cardid:cardid,downtime:downtime},
			  url: "/kj133/workattleader.do?method=getAll",
			  dataType:"json",
  ...
  <logic:messagesPresent message="true">
       ...
       <html:form action="workattleader.do?method=getList"
           ...
           <table width="100%">
               <tr>
				...
				<th align="left">
					<html:text property="search_workatt.cardid" styleId="name" style="width: 125px;"></html:text>
				</th><th>&nbsp;&nbsp;</th>
                 <th align="left">部门:</th>
                 <th align="left">
                 ...
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 	当前井下领导人数：&nbsp;&nbsp;<font color="red" size=6>${countall}</font>&nbsp;&nbsp;人
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                 </th>
                 <th> 
                 	<a href="javascript:void(0)" onclick="refresh()" style="text-decoration:none;"><font color="blue">刷新</font></a>
                 </th>
       ...
       <table width="100%" cellspacing="1" cellpadding="1"  bgcolor="#6CA6CD" border="0" style="border-collapse:collapse;TABLE-LAYOUT:   fixed;   FONT-SIZE:   13px;">
	         <tr>
	         	<th><font style="font-family:verdana" color="red">*红色为呼救报警</font></th>
	         	<th><font style="font-family:verdana" color="blue">*蓝色为超时报警</font></th>
	         </tr>
	         <tr>
		      	...
		      	<logic:iterate name="workatt_list" id="workatt">
		      	  ...
		      	  <%--  呼救+ 超时     --%>
		      	    ...
		      	    <logic:equal  name="workatt" property="state" value="0">
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="red"><bean:write name="workatt" property="name" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="red"><bean:write name="workatt" property="cardid" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="red"><bean:write name="workatt" property="group" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="red"><bean:write name="workatt" property="occupation" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="red"><bean:write name="workatt" property="downtime" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="red"><bean:write name="workatt" property="worktime" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="red"><bean:write name="workatt" property="crname" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="red"><bean:write name="workatt" property="starttime" /></FONT></td>
		      	     <td align="center" bgcolor="#E6E6FA"><FONT color="red"><html:link  onclick="gjdetail(${workatt.cardid},'${workatt.downtime}')" href="javascript:void(0)">明细</html:link></FONT>
		      	    </td>
		      	    </logic:equal>
		      	    </logic:equal>
		      	  ...
		      	  <logic:equal  name="workatt" property="overstate" value="3">
		      	    ...
		      	    <logic:equal  name="workatt" property="state" value="1">
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="blue"><bean:write name="workatt" property="name" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="blue"><bean:write name="workatt" property="cardid" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="blue"><bean:write name="workatt" property="group" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="blue"><bean:write name="workatt" property="occupation" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="blue"><bean:write name="workatt" property="downtime" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="blue"><bean:write name="workatt" property="worktime" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="blue"><bean:write name="workatt" property="crname" /></FONT></td>
		      	     <td align="left" bgcolor="#E6E6FA"><FONT color="blue"><bean:write name="workatt" property="starttime" /></FONT></td>
		      	     <td align="center" bgcolor="#E6E6FA"><FONT color="blue"><html:link  onclick="gjdetail(${workatt.cardid},'${workatt.downtime}')" href="javascript:void(0)">明细</html:link></FONT>
		      	    </td>
		      	    </logic:equal>
		      	    </logic:equal>
		      	    ...
		      	    <%--   正常   --%>
		      	     ...
		      	     <td align="center" bgcolor="#E6E6FA"><html:link  onclick="gjdetail(${workatt.cardid},'${workatt.downtime}')" href="javascript:void(0)">明细</html:link></td>
		      	     </logic:equal>
		      	     </logic:equal>
		      	  </tr>
		      	</logic:iterate>
		    ...
		    <logic:present name="pagination">
					<TR>
						<TD colspan="9" align="center" bgcolor="#E6E6FA">
							<page:pagination path="workattleader.do?method=getList"

...
<head>
	...
	<title>worktype_areadis_right.jsp</title>
...
<body bgColor="white" background="Image/right.gif">
	...
	<html:form action="worktype_areadis_right?method=init" onsubmit="return check()">
       
		<%-- 
          <div   style="overflow:auto;width:825;height:500;"> 
          --%>
         
          <td ><font size="2" color="red">工种区域分布表---区域分布:</font></td>

               ...
               tree = new dTree('tree');
	              tree.add(0,'-1','用户管理');
	                   <logic:present name="tree">
		                   ...
		                   <logic:equal  name="list" property="pid" value="0">
				                  ...
				                  '','mainFrame',tree.icon.folder,tree.icon.folderOpen);
				           </logic:equal>
				           <logic:notEqual  name="list" property="pid" value="0">
			                      tree.add('<bean:write name="list" property="id" />','<bean:write name="list" property="pid" />',
				                  '<bean:write name="list" property="name" />','<bean:write name="list" property="link" />',
				                  '','mainFrame',tree.icon.node);
				           </logic:notEqual>
		                    </logic:iterate>
	                   </logic:present>
	            document.write(tree); 

...
<%@ page import="com.kj133.entity.Search_OverTime" %>
<%@ page import="java.util.*" %>
<%@ page import="java.io.*" %>
    <%
      //报表编译之后生成的.jasper 文件的存放位置
      response.reset();
      File reportFile = new File(application.getRealPath("reports/overTime.jasper"));
      //传递报表中用到的参数值
      Search_OverTime jf = (Search_OverTime)request.getSession().getAttribute("OverTime");
      
      Map parameters = new HashMap();     
      parameters.put("ktime",jf.getStime());
      parameters.put("jtime",jf.getEtime());
      
      List dyList = (ArrayList)request.getAttribute("over_ListPrint");

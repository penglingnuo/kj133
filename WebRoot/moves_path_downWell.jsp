...
<html:html lang="true">
  <head>
    ...
    <SCRIPT language="JavaScript">
     ...
     <SCRIPT language="JavaScript">
       ...
       function choise(){
               var time = document.all("showTime");
			    for (var i=0; i<time.length; i++)
			    {
			      if(time[i].checked){
			          var show=time[i].value;
			          var i=show.indexOf("+");
			          var cid=show.substring(0,i);//卡号
			          
			          var j=show.indexOf(".");
			          var stime=show.substring(i+1,j);//开始时间
			          
			          var j=show.lastIndexOf("+");
			          var k=show.lastIndexOf(".");
			          var etime=show.substring(j+1,k);
			          
			          window.location.href="Moves_path.do?method=moves_path_Choise&cid="+cid+"&stime="+stime+"&etime="+etime;
			          break;
			        }
			   }
  ...
  <body bgColor="white" background="Image/right.gif" >
     ...
     <html:form action="Moves_path?method=moves_path_Result" onsubmit="return check()" >
          ...
          <%--<div   style="overflow:auto;width:100%;height:420;"> 
          --%>
          <div id = "printdiv">
                 ...
                 <logic:iterate name="downWell_list" id="dw">
                     <tr>
                       <td align="left" bgcolor="#E6E6FA">
                         <input type="radio"  id="showTime"  name="radio" onclick="choise()" value="<bean:write name='dw' property='stafferid' />+<bean:write name='dw' property='intime' />+<bean:write name='dw' property='upwelltime' />" /> 
                         <bean:write name="dw" property="kqtime" />
                         </td>
               ...
               <logic:present name="pagination" >
                  <tr>
					   <td colspan="18" align="left" bgcolor="#E6E6FA">
					        <page:pagination path="Moves_path.do?method=moves_path_Result" parameter="page" formName="Search_ShuaKa_Form" />
					  </td>  
                   </tr> 
                </logic:present> 
         </table>   </div>

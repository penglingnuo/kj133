...
<html:html lang="true">
  <head>
    ...
    <title>addEditViewReader.jsp</title>
    ...
    <script language="JavaScript">
     ...
     <SCRIPT language="javascript">
       function check()
       {
             if(document.all['ser_operator_viewReader.cardreaderid'].value=="")
              {
                alert("分站号不能为空");
                document.all['ser_operator_viewReader.cardreaderid'].focus();
                return false;
              }
             if(document.all['ser_operator_viewReader.cardreaderid'].value == 0)
              {
                alert("分站号应当是1到1024之间");
                document.all['ser_operator_viewReader.cardreaderid'].value="";
                document.all['ser_operator_viewReader.cardreaderid'].focus();
                return false;
              } 
              if(document.all['ser_operator_viewReader.cardreaderid'].value >=1025)
              {
                 alert("分站号应当是1到1024之间");
                 document.all['ser_operator_viewReader.cardreaderid'].value="";
                document.all['ser_operator_viewReader.cardreaderid'].focus();
  ...
  <body bgColor="white" background="Image/right.gif">
      ...
      <html:form action="/operartrViewReader?method=save" focus="ser_operator_viewReader.cardreaderid" onsubmit="return check()">
        <TABLE border="0">
           <TR>
             <TD colspan="2">
              增加分站信息 &nbsp;&nbsp;<font color="red">（*为必填内容）</font>&nbsp;&nbsp;<input type="button" value="返 回"  onClick="history.back()">
             </TD>
           </TR>
           <TR>
              <TD>分&nbsp;站&nbsp;号：</TD>
              <TD><html:text property="ser_operator_viewReader.cardreaderid" maxlength="4" onkeyup="this.value=this.value.replace(/\D/g,'')" /><font color="red">&nbsp;&nbsp;*</font></TD>
           </TR>
           <TR>
              <TD>分&nbsp;站&nbsp;名：</TD>
              <TD><html:text property="ser_operator_viewReader.crname" maxlength="25" onkeyup="this.value=this.value.replace(/([\s\u3000]*)|([\s\u3000]*$)/g, '')" /><font color="red">&nbsp;&nbsp;*</font></TD>
           </TR>
           <TR>
              <TD>简&nbsp;&nbsp;&nbsp;&nbsp;称：</TD>
              <TD><html:text property="ser_operator_viewReader.shortname" maxlength="20" onkeyup="this.value=this.value.replace(/([\s\u3000]*)|([\s\u3000]*$)/g, '')" /></TD>
           </TR>
           <TR>
              <TD>地图X坐标：</TD>
           ...
           <TR>
              <TD>忽略中断：</TD>
              <TD><html:text property="ser_operator_viewReader.ignoretimes" maxlength="2" onkeyup="this.value=this.value.replace(/\D/g,'')" /></TD>
           </TR>
           <TR>
              <TD>指定忽略中断：</TD>
           ...
           <TR>
              <TD>使用状态：</TD>
              <TD><html:select property="ser_operator_viewReader.state" style="width:152px">
           ...
           <TR>
              <TD>考勤分站：</TD>
              <TD><html:select property="ser_operator_viewReader.checkreader" style="width:152px">
         ...
         <script>
			document.all("ser_operator_viewReader.useantenna")[0].checked=true;
		 </script>
  </body>
</html:html>

...
<head>
	...
	<title>area_padlock_top.jsp</title>
	...
	<SCRIPT language="JavaScript">
       function check()
         {
	         var stime=document.all['area_padlock_top.stime'].value;
	         var etime=document.all['area_padlock_top.etime'].value;
	         if( stime > etime){
	            alert('起始时间不能大于截止时间');
	            return false;
         }
...
<body bgColor="white" background="Image/right.gif">
	...
	<html:form action="area_padlock_top?method=init" onsubmit="return check()">
		<table  width="650">
			<tr>
				<th>
					起始日期：
				...
				<th align="left">
                 <html:text property="area_padlock_top.stime" size="18" onfocus="WdatePicker({skin:'whyGreen',isShowClear:false,dateFmt:'yyyy-MM-dd HH:mm:ss',el:$dp.$('area_padlock_top.stime')})"/>
                 </th>
				<%--<th>
					<html:text property="area_padlock_top.stime" size="18"
						onfocus="show_cele_date('','',Search_area_padlock_top_Form['area_padlock_top.stime'])" />
				</th>
				--%><th>
					&nbsp;&nbsp;
				</th>
				...
				<th align="left">
                 <html:text property="area_padlock_top.etime" size="18" onfocus="WdatePicker({skin:'whyGreen',isShowClear:false,dateFmt:'yyyy-MM-dd HH:mm:ss',el:$dp.$('area_padlock_top.etime')})"/>
                 </th>
				<%--<th>
					<html:text property="area_padlock_top.etime" size="18"
						onfocus="show_cele_date('','',Search_area_padlock_top_Form['area_padlock_top.etime'])" />
				</th>
				...
				<th>
	                 ...
	                 <logic:notEqual name="listCount" value="0">
	                     ...
	                     <input type="button"  value="打印预览"  onclick="javascript:window.open('area_padlock_topPrint.jsp')">
	               </logic:notEqual>
                 </th>
		...
		<td ><font size="2" color="red">区域禁入:</font></td>
		<%-- 
			...
			<logic:present name="relist" scope="request">
				...
				<tr onmouseover="this.style.background='#CCCCCC'; " onmouseout ="this.style.background=''; this.style.borderColor=''">
						...
						<td align="center" bgcolor="#E6E6FA">
							<a href="area_padlock_down.do?method=init&aid=<bean:write name="relist" property="aid" />&atime=<bean:write name="relist" property="atime" />" title="区域禁入人员明细" onmousemove="javascript:window.status=''"  onmouseout="javascript:window.status=''" class="A:link"  target="down" >
						...
						<td align="left" bgcolor="#E6E6FA">
							<bean:write name="relist" property="atime" />
						</td>
						<td align="left" bgcolor="#E6E6FA">
						<bean:write name="relist" property="acount" />

...
<%@ page import="com.kj133.entity.Search_car_check_menology" %>
<%@ page import="java.util.*" %>
<%@ page import="java.io.*" %>
    <%
      //报表编译之后生成的.jasper 文件的存放位置
      response.reset();
      File reportFile = new File(application.getRealPath("reports/car_check_menology.jasper"));
      //传递报表中用到的参数值
      Search_car_check_menology jf = (Search_car_check_menology)request.getSession().getAttribute("car_check_menology");
      
      Map parameters = new HashMap();     
      parameters.put("sstime",jf.getStime());
        
      List dyList = (ArrayList)request.getSession().getAttribute("car_check_menologyPrint");

...
<%@ page import="com.kj133.entity.Search_area_padlock_top" %>
<%@ page import="java.util.*" %>
<%@ page import="java.io.*" %>
    <%
      //报表编译之后生成的.jasper 文件的存放位置
      response.reset();
      File reportFile = new File(application.getRealPath("reports/area_padlock_down.jasper"));
      //传递报表中用到的参数值
      Search_area_padlock_top jf = (Search_area_padlock_top)request.getSession().getAttribute("area_padlock_top");
      
      Map parameters = new HashMap();     
      parameters.put("sstime",jf.getStime());
      parameters.put("eetime",jf.getEtime());  
        
      List dyList = (ArrayList)request.getSession().getAttribute("area_padlock_downPrint");

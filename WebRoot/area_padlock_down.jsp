...
<head>
	...
	<title>area_padlock_down.jsp</title>
...
<body bgColor="white" background="Image/right.gif">
	...
	<html:form action="area_padlock_down?method=init" onsubmit="return check()">

		<%-- 
          <div   style="overflow:auto;width:825;height:500;"> 
          --%>
          
          <td ><font size="2" color="red">区域禁入人员明细:</font></td>
          				<td>
	                 ...
	                 <logic:notEqual name="listCount1" value="0">  
	                     ...
	                     <input type="button"  value="打印预览"  onclick="javascript:window.open('area_padlock_downPrint.jsp')">
	               </logic:notEqual>
                 </td>
		...
		<table cellspacing="1" cellpadding="1" bgcolor="#6CA6CD" border="0"
			...
			<logic:present name="relist" scope="request">
				...
				<tr onmouseover="this.style.background='#CCCCCC'; " onmouseout ="this.style.background=''; this.style.borderColor=''">
						...
						<td align="left" bgcolor="#E6E6FA">
							<bean:write name="relist" property="cid" />
						</td>
						<td align="left" bgcolor="#E6E6FA">
						...
						<td align="left" bgcolor="#E6E6FA">
							<bean:write name="relist" property="stl" />
						</td>

...
<%@ page import="java.io.*" %>
    <%
      ...
      response.reset();
      File reportFile = new File(application.getRealPath("reports/downWellCount.jasper"));
      //传递报表中用到的参数值
      Search_DownWellCount jf = (Search_DownWellCount)request.getSession().getAttribute("downwellcount");
      ...
      List dyList = (ArrayList)request.getSession().getAttribute("downWellCountPrint");

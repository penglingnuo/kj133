...
<%@ page import="java.io.*" %>
    <%
      ...
      response.reset();
      File reportFile = new File(application.getRealPath("reports/abnormity_work_down.jasper"));
      //传递报表中用到的参数值
      ...
      List dyList = (ArrayList)request.getSession().getAttribute("abnormity_work_downPrint");

...
<html:html lang="true">
  ...
  <body bgColor="white"  style="overflow:hidden">   
      <html:form action="gjuser?method=gjuserLogin" focus="gjuser.gjusername" onsubmit="return check()">
	      <div align="center">
	        <br><br><br><br><br><br>
                      ...
                      <div align="center">
                          <table width="300">
			                 ...
			                 <tr>
					            ...
					            <td><html:text  property="gjuser.gjusername" size="18" style="width: 130px;"  /></td>
			                 </tr>
			                 <tr>
				               	<td  align="right" height=30 ><FONT color=1771DE>密　码：</FONT></td>
				                <td><html:password property="gjuser.gjuserpwd"  redisplay="false" size="18"  style="width: 130px;" /></td>
				             </tr>
				             <tr>
			                     <td>&nbsp;</td>
			                     <td>&nbsp;</td>

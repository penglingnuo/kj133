...
<frameset cols="*" rows="55%,*" framespacing="1" frameborder="no"
	...
	border="1">
			<frame src="areatime_query_top.do?method=getWordlib" name="top_left"
			scrolling="auto" noresize="noresize" id="top_left"
			title="top_left" />
			
			<frame src="areatime_query_right.jsp" name="top_right"
			id="top_right" title="top_right" />

	</frameset>		
			<frame src="areatime_query_down.jsp" name="down"
			id="down" title="down" />

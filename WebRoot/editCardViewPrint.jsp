...
<html:html lang="true">
  <head>
    ...
    <title>editCardViewPrint.jsp</title>
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
		<%
			...
			{
		%>
		        <td><a href="editcard.do?method=viewPrint&page=0"><img src="images/first.GIF" border="0"></a></td>
		        <td><a href="editcard.do?method=viewPrint&page=<%=pageIndex - 1%>"><img src="images/previous.GIF" border="0"></a></td>
		<%
			}
			else
			{
		...
		<%
			...
			{
		%>
		        <td><a href="editcard.do?method=viewPrint&page=<%=pageIndex + 1%>"><img src="images/next.GIF" border="0"></a></td>
		        <td><a href="editcard.do?method=viewPrint&page=<%=lastPageIndex%>"><img src="images/last.GIF" border="0"></a></td>
		<%
			}
			else
			{
		...
		<td width="6%" height="1%">&nbsp;&nbsp;&nbsp;
          <APPLET  CODE = "PrinterApplet.class" CODEBASE = "applets" ARCHIVE = "jasperreports-2.0.2-applet.jar, PrinterApplet.jar" WIDTH = "255" HEIGHT = "37">
            ...
            <PARAM NAME = "REPORT_URL" VALUE ="../editcard.do?method=printEditCard">
         </APPLET>
         </td>
